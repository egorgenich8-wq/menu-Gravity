[menu.html](https://github.com/user-attachments/files/27652642/menu.html)
<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=yes">
    <title>Меню | GRAVITY Кафе</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        body {
            background: #1a1e24;  /* тёмный фон под "гравитацию" */
        ...
        /* карточка меню — эффект бумаги со свечением */
        .menu-card {
            max-width: 600px;
            margin: 0 auto;
            background: #0f1217;
        ...
        /* для подгрупп (например, хычины с подробностями) */
        .item-desc {
            font-size: 0.75rem;
            color: #8f9aae;
            margin-top: 4px;
        ...
        /* специальный блок для шашлыка и мяса */
        .grill-note {
...
<div class="menu-card">
    ...
    <div class="menu-section">
        ...
        <div class="menu-grid">
            ...
            <div class="menu-item"><div class="item-name">Шашкука</div><div class="item-price">250₽</div></div>
    ...
    <div class="menu-section">
        ...
        <div class="grill-note">
            ⚡ Блюда приготовлены на живом огне. Для заказа уточняйте вес и порции у официанта.
        </div>
    </div>

    <!-- небольшой раздел: дополнительная информация или совет -->
    <div class="qr-footer">
        ...
        <p style="margin-top: 12px;">✨ Актуальные цены указаны в меню ✨</p>
    </div>
</div>
</body>
</html>
